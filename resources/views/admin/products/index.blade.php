                    ...
                    <tr>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <div class="flex-shrink-0 w-16 h-16">
                                <img class="w-full h-full object-contain" src="{{ asset($product->image) }}" alt="{{ $product->name }}">
                            </div>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">Rs. {{ number_format($product->price) }}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <span class="relative inline-block px-3 py-1 font-semibold leading-tight {{ $product->stock > 0 ? 'text-green-900' : 'text-red-900' }}">
                                <span aria-hidden class="absolute inset-0 {{ $product->stock > 0 ? 'bg-green-200' : 'bg-red-200' }} opacity-50 rounded-full"></span>
